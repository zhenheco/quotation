...
export const CUSTOMER_COLUMNS: ImportTemplateColumn[] = [
  ...
  },
  {
    ...
    descriptionEn:
      "Customer email, optional, used for duplicate detection if provided",
...
/** 發票匯入欄位定義 */
export const INVOICE_COLUMNS: ImportTemplateColumn[] = [
  {
    key: "number",
    header: "發票號碼 *",
    ...
    width: 20,
    required: true,
    description: "統一發票字軌號碼，必填",
    descriptionEn: "Invoice tracking number, required",
    example: "AB-12345678",
  },
  {
    key: "date",
    header: "發票日期 *",
    headerEn: "Invoice Date *",
    width: 15,
    required: true,
    description: "開票日期（支援民國年 113/03/06 或西元 2024-03-06）",
    descriptionEn: "Issue date (supports ROC 113/03/06 or Western 2024-03-06)",
    example: "113/03/06",
  },
  {
    key: "untaxed_amount",
    header: "未稅金額 *",
    headerEn: "Untaxed Amount *",
    width: 15,
    required: true,
    description: "銷售額（未含稅），必填",
    descriptionEn: "Sales amount before tax, required",
    example: "10000",
  ...
  },
  {
    ...
    width: 15,
    required: false,
    description: "營業稅額，選填（空白自動計算 5%）",
    descriptionEn: "Business tax amount, optional (auto-calculated as 5%)",
    example: "500",
    validation: { type: "number" },
  },
  {
    ...
    width: 15,
    required: false,
    description: "交易對象統一編號（8 碼），選填",
    descriptionEn: "Counterparty tax ID (8 digits), optional",
    example: "12345678",
  },
  {
    key: "counterparty_name",
    header: "交易對象",
    headerEn: "Counterparty Name",
    width: 25,
    required: false,
    description: "買方或賣方名稱，選填",
    descriptionEn: "Buyer or seller name, optional",
    example: "台北科技股份有限公司",
  },
  {
    key: "deductible",
    ...
    width: 10,
    required: false,
    description: "是否可扣抵（Y/N），僅進項發票需填",
    descriptionEn: "Deductible (Y/N), for purchase invoices only",
    example: "Y",
    validation: { type: "list", values: ["Y", "N", "y", "n", ""] },
  },
  {
    key: "is_fixed_asset",
    header: "固定資產",
    headerEn: "Fixed Asset",
    width: 10,
    required: false,
    description: "是否為固定資產（Y/N），預設 N",
    descriptionEn: "Is fixed asset (Y/N), default N",
    example: "N",
    validation: { type: "list", values: ["Y", "N", "y", "n", ""] },
  },
  {
    ...
    required: false,
    description: "發票備註說明",
    descriptionEn: "Invoice description or notes",
    example: "辦公室用品",
  },
];
