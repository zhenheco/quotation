-- ============================================================================
-- 快速修復腳本：修復 orders.created_by 外鍵約束問題
-- ============================================================================
-- 在 Supabase SQL Editor 執行此腳本
--
-- 問題：報價單轉訂單失敗，錯誤訊息：
-- "insert or update on table orders violates foreign key constraint orders_created_by_fkey"
--
-- 原因：orders.created_by 外鍵參考 user_profiles(id)，但傳入的是 auth.users.id
-- ============================================================================
