...
-- 測試數據腳本
-- ========================================
-- 注意：執行此腳本前，請先將 {USER_ID} 替換為實際的 user_id
-- 您可以在 Supabase Dashboard → Authentication → Users 中找到您的 user_id
-- 或者使用以下 SQL 查詢：SELECT id FROM auth.users LIMIT 1;
-- ========================================
...
-- - 5 個客戶（台灣 4 個，美國 1 個）
-- - 10 個產品（各類辦公設備和電腦週邊）
-- - 5 個報價單（各種狀態：draft, sent, accepted, rejected）
-- - 約 20 個報價單項目
-- - 8 組匯率數據
-- ========================================
