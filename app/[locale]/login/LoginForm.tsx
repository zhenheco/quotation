    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white text-gray-500">{t('login.orWithEmail')}</span>
        </div>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        {t('login.noAccount')}{' '}
        <Link href={`/${locale}/register`} className="text-indigo-600 hover:text-indigo-500 font-medium">
          {t('login.signUp')}
        </Link>
      </p>
