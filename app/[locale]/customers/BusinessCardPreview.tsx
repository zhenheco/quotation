              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">
                    {t('company')} <span className="text-gray-400">({t('referenceOnly')})</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">
                    {t('title')} <span className="text-gray-400">({t('referenceOnly')})</span>
                  </label>
                  <input
                    type="text"
