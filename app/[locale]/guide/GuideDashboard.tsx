...
export default function GuideDashboard() {
  ...
  if (!selectedCategory) {
    return (
      <div className="space-y-6">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-800">{t('guide.title')}</h1>
          <p className="text-muted-foreground mt-2">{t('guide.description')}</p>
        </div>
              ...
              >
                <CardHeader className="text-center pb-2">
                  ...
                  <CardTitle className="text-lg">
                    {locale === 'zh' ? content.titleZh : content.title}
                  </CardTitle>
                  <CardDescription>
                    {locale === 'zh' ? content.descriptionZh : content.description}
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-sm text-muted-foreground">
                    {content.steps.length} {t('guide.steps')}
                  </p>
                  <Button variant="ghost" className="mt-4 gap-2">
                    {t('guide.startLearning')}
  ...
  const stepData = locale === 'zh' ? step.zh : step.en
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground text-center">
        {t('guide.stepOf', { current: currentStep + 1, total: totalSteps })}
      </p>
        ...
        <CardHeader className="bg-gradient-to-r from-slate-50 to-white pb-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <CardDescription className="mt-1">{t('guide.step')} {currentStep + 1}</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-6">
          ...
          {stepData.tips && stepData.tips.length > 0 && (
            <div className="rounded-lg bg-amber-50 border border-amber-200 p-4">
              <h4 className="font-medium text-amber-800 mb-2">{t('guide.tips')}</h4>
